...
def write_loan_data(loan_data):
    ...
    cur.execute("commit")
    refno = cur.lastrowid #This read-only attribute provides the rowid of the last modified row. 
    print(refno)          #It is only set if you issued a INSERT statement using the execute() method.
